            ...
            <DialogContent>
                <Box component="form" sx={{ display: 'flex', flexDirection: 'column', gap: 2, pt: 2 }}>
                    ...
                    <FormControl>
                        ...
                        <RadioGroup row name="status-group" value={status} onChange={(e) => setStatus(e.target.value)}>
                            <FormControlLabel value="Em uso" control={<Radio size="small" />} label="Em uso" />
                            <FormControlLabel value="Em manutenção" control={<Radio size="small" />} label="Em manutenção" />
                            <FormControlLabel value="Disponível" control={<Radio size="small" />} label="Disponível" />
                            <FormControlLabel value="Descartado" control={<Radio size="small" />} label="Descartado" />
                        </RadioGroup>
                    </FormControl>
                </Box>
            </DialogContent>
